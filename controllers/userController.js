...
exports.updateMe = catchAsync(async(req,res,next) => {
  ...
  // 2- filter the body for the specific fields 
  const filteredBody = filterObj(req.body,'name','email');
  
  // 3- update user document
  
  // we need that as we now don't deal with sensitive data as passwords
...
// don't update passwords with this!!, you know why
